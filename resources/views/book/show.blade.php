    ...
    <section class="text-gray-600 body-font overflow-hidden ">
        ...
        <div class="container px-5 py-5 mx-auto">
            ...
            alt="imagen del post {{ $book->titulo }}"
                ...
                <img alt="imagen del post {{ $book->titulo }}" class="lg:w-1/4 max-w-screen-sm sm:h-72 lg:h-full object-cover object-center rounded" src="{{ asset('img/portada3.jpg')}}">
            ...
            <div class="lg:w-1/3 w-full lg:pl-2 lg:py-6 mt-6 lg:mt-0 lg:border-l border-gray-900 ">
                ...
                <h1 class="text-gray-900 text-3xl pl-10 title-font font-bold mb-1">Bs. {{ $book->precio }}</h1>
                ...
                <div class="p-2 text-left w-60" role="alert">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="flex mt-2">
                            ...
                            <p class="font-bold px-2 mb-5 text-sm ">¡También puedes comprarlo y recogerlo en nuestras Tiendas!</p>
                        </div>
                        <div class="flex">
