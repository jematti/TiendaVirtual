...
@section('contenido-admin')
    ...
    <h2 class="bg-white text-lg rounded-lg p-4 text-center font-bold border-2 border-sky-800">Lista de Editoriales</h2>
    ...
    <!-- Table -->
        <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            <header class="px-5 py-4 border-b border-gray-100">
                <div class="font-semibold text-gray-800">Editorial</div>
            </header>
                            ...
                            <tr>
                                ...
                                <td class="p-2">
                                    <div class="font-medium text-gray-800">
                                        {{ $editorials->nombre_editorial }}
                                    </div>
                                </td>
                                <td class="p-2">
                                    <div class="text-left">
                                       {{ $editorials->direccion }}
                                    </div>
                                </td>
                                ...
                                <td class="p-2">
                                        <div class="flex justify-center">
                                            ...
                                            {{-- editar --}}
                                            <a href="{{ route('editorial.edit',$editorials->id) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
